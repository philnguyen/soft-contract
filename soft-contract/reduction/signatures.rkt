...
(define-substructs F
  ...
  [F:Μ/C Symbol]
  [F:==>:Dom W (Listof ⟦E⟧) (Option ⟦E⟧) ⟦E⟧ Ρ ℓ Boolean]
  [F:==>:Rst W ⟦E⟧ Ρ ℓ Boolean]
  [F:==>:Rng W (Option V^) ℓ Boolean]
  [F:==>i Ρ (Listof Dom) (Pairof Symbol ℓ) (Listof ⟦dom⟧) Boolean]
