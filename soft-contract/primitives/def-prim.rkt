...
(define-syntax (def-prim/custom stx)
  ...
  (syntax-parse stx
    [(_ (o:id ⟪ℋ⟫:id ℓ:id Σ:id $:id Γ:id Ws:id)
        #:domain ([W:id c:fc] ...)
        e:expr ...)
     ...
     (define defn-o
       #`(begin
           ...
           (update-arity! 'o #,n)))
     (gen-defn #'o #'.o defn-o)]
    [(_ (o:id ⟪ℋ⟫:id ℓ:id Σ:id $:id Γ:id Ws:id) e:expr ...)
     (define/with-syntax .o (prefix-id #'o))
  ...
  (syntax-parse stx
    ...
    [(_ o:id c:hf)
     ...
     #`(def-ext (o ℓ Ws $ Γ ⟪ℋ⟫ Σ ⟦k⟧)
         ...
         (define αₖ (-ℋ𝒱 $ ⟪ℋ⟫))
         (define κ (-κ (bgn0.e∷ Wₐ '() ⊥ρ ⟦k⟧) Γ ⟪ℋ⟫ #f ⊤$* ∅ #t))
         (σₖ⊕! Σ αₖ κ)
         {set (-ς↑ αₖ)})]
    ...
    [(_ (o:id ℓ:id Ws:id $:id Γ:id ⟪ℋ⟫:id Σ:id ⟦k⟧:id) e:expr ...)
     (define/with-syntax .o (prefix-id #'o))
     (define defn-o #`(define (.o ℓ Ws $ Γ ⟪ℋ⟫ Σ ⟦k⟧) e ...))
     (gen-defn #'o #'.o defn-o)]))
