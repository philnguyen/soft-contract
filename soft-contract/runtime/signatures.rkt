...
(struct -ℳ -αₖ ([var : Symbol] [l³ : -l³] [loc : ℓ] [ctc : -V] [val : -V] [pc : -Γ]) #:transparent) ; Contract monitoring
(struct -ℱ -αₖ ([var : Symbol] [l : -l] [loc : ℓ] [ctc : -V] [val : -V] [pc : -Γ]) #:transparent) ; Flat checking
