...
(provide
 (contract-out
  [do-remove (any/c list? . -> . list?)]
  [memf ((any/c . -> . any/c) list? . -> . any/c)]
  [findf ((any/c . -> . any/c) list? . -> . any/c)]
  [foldl ((any/c . -> . any/c) any/c list? . -> . any/c)]
  [foldr ((any/c . -> . any/c) any/c list? . -> . any/c)]
  [filter ((any/c . -> . any/c) list? . -> . any/c)]))

(define (do-remove item list)
  (let loop ([list list])
    (cond [(null? list) null]
